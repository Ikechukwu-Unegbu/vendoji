...
@section('content')
                ...
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card pt-3 info-card sales-card">
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body pt-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>{{$all_locks}} Locks</h6>
                                            <span class="text-danger small pt-1 fw-bold">{{$unique_locks}} Unique Locks</span> <span
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div>
                                        <canvas id="userMonthlyCharts"></canvas>
                                    </div>
    ...
    @push('scripts')
        <script>
            ...
            const configuserMonthlyCharts = {
                type: 'line',
                data: dataUsers,
                options: {}
            };
            const userMonthlyCharts = new Chart(
                document.getElementById('userMonthlyCharts'),
                configuserMonthlyCharts
            );
        </script>
