    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="createWallet">Create New Wallet For User</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('panel.admin.wallet.create') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group mb-4">
                        <label for="coin" class="form-label">Select a User <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group mb-4">
                        <label for="password" class="form-label">Create Password for User <span class="text-danger">*</span></label>
